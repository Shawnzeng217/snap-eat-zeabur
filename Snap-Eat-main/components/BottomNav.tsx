...
export const BottomNav: React.FC<BottomNavProps> = ({ currentScreen, onNavigate }) => {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 z-50 flex border-t border-[#f5f1f0] dark:border-white/10 bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur-lg px-4 pb-4 pt-2 shadow-[0_-5px_10px_rgba(0,0,0,0.02)]">
      <button 
